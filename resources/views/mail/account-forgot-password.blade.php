...
<div style="margin: 25px 0;">
    <a style="margin: 0; background-color: #353535; color: white; border-radius: 8px; padding: 15px 25px; display: inline-block; font-size: 17px; text-decoration: none;" href="{{ route('reset-password', [$mail['user']->email, $mail['token']]) }}">Reset Password</a>
</div>
